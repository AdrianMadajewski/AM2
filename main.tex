...
\begin{proof}
    ...
    W szczególnośći funkcja $\phi$ jest ciągła na $\mathbb{R}$. Określmy
...
\begin{theorem}
{
    ...
    $\alpha = \limsup\limits_{n \to \infty}\sqrt[n]{|c_n|}$ (jeśli $\alpha = 0$, to $R = +\infty$, jeśli $\alpha = +\infty$, to $R = 0$).
}
\end{theorem}
...
\begin{proof}
    ...
    \[
        \limsup\limits_{n \to \infty}\sqrt[n]{|a_n|} = |z| \limsup\limits_{n \to \infty}\sqrt[n]{|c_n|} = |z|\alpha.
    \]
    ...
    Dalej jeśli $\alpha = 0$, to $\limsup\limits_{n \to \infty}\sqrt[n]{|a_n|} = 0$, zatem szereg potęgowy jest zbieżny dla każdego $z \in \mathbb{C}$, czyli $R = +\infty$. \\
    W końcu jeśli $\alpha = + \infty$, to $\limsup\limits_{n \to \infty}\sqrt[n]{|a_n|} = + \infty$, czyli szereg potęgowy jest rozbieżny dla 
    każdego $z \neq 0$, a zatem $R = 0$.
\end{proof}
